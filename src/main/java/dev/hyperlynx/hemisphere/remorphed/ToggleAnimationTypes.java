...
public class ToggleAnimationTypes {
    public static final DeferredRegister<ToggleAnimationType> TYPES = DeferredRegister.create(ToggleAnimationType.class, Hemisphere.MODID);
    public static final Supplier<IForgeRegistry<ToggleAnimationType>> REGISTRY = TYPES.makeRegistry("toggle_animation_type", RegistryBuilder::new);
